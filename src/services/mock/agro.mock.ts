  ...
  return [
    {
      ...
      cropName: 'Cilantro',
      loteName: 'Lote Norte',
      description: 'Cosecha programada de cilantro. Coordinar personal y transporte.',
    ...
    {
      id: '2',
      title: 'Aplicacion de fertilizante',
      type: 'fertilization',
      cropName: 'Tomate',
      loteName: 'Lote Norte',
      description: 'Aplicar fertilizante organico NPK a cultivo de tomate en crecimiento.',
    ...
    },
    {
      ...
      type: 'irrigation',
      loteName: 'Lote Central',
      description: 'Activar sistema de riego por goteo en Lote Central.',
    ...
    },
    {
      ...
      cropName: 'Chile',
      loteName: 'Lote Central',
      description: 'Inspeccion y tratamiento preventivo contra acaros en chile.',
    ...
    {
      id: '5',
      title: 'Preparacion de terreno',
      type: 'maintenance',
      loteName: 'Lote Este',
      description: 'Preparar suelo para proxima siembra de temporada.',
