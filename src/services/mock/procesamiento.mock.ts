  ...
  return [
    {
      ...
      batchCode: 'PROC-2026-003',
      description: 'Analisis de laboratorio para lote de miel. Verificar humedad y pureza.',
    ...
    },
    {
      ...
      lineCode: 'LINEA-004',
      description: 'Mantenimiento preventivo de equipos de la linea de procesamiento de carnes.',
    ...
    },
    {
      ...
      batchCode: 'PROC-2026-004',
      description: 'Procesamiento de chile jalapeno para encurtidos. 500kg estimados.',
    ...
    },
    {
      ...
      lineCode: 'LINEA-002',
      description: 'Calibrar termometros y sensores de la linea de lacteos.',
    ...
    },
    {
      ...
      type: 'batch_processing',
      description: 'Definir plan de produccion para la semana del 10-14 febrero.',
