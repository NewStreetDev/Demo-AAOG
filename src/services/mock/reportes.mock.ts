...
export const getMockReportesDashboardStats = async (): Promise<ReportesDashboardStats> => {
  ...
  return {
    ...
    byType: [
      { reportType: 'RG01', count: 4 },
      { reportType: 'RG03', count: 6 },
      { reportType: 'RG05', count: 5 },
      { reportType: 'RP02', count: 5 },
      { reportType: 'RP03', count: 4 },
      { reportType: 'RG06', count: 4 },
    ],
    recentGenerations: [
      {
        reportCode: 'REP-2026-001',
        reportType: 'RG03',
        reportTypeName: 'Bitácora de Labores',
        associateName: 'Juan Pérez',
...
export const getMockReportesTasks = async (): Promise<ReportesTask[]> => {
  ...
  return [
    ...
    {
      id: '4',
      title: 'Generar Balance de Masas Q4',
      type: 'generation_pending',
      reportType: 'BALANCE_MASAS',
      year: 2025,
    ...
    {
      id: '5',
      title: 'Revisar RG06 procesamiento',
      type: 'review_required',
      reportType: 'RG06',
      year: 2026,
