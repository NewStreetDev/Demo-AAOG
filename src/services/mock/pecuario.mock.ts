...
const initialLivestock: Livestock[] = [
    // === BOVINOS ===
    {
      ...
      weight: 520,
      status: 'active',
      location: { potreroId: '1', potreroName: 'Potrero Norte' },
    ...
    },
    {
      ...
      weight: 850,
      status: 'active',
      location: { potreroId: '2', potreroName: 'Potrero Central' },
    ...
    },
    {
      ...
      weight: 380,
      status: 'active',
      location: { potreroId: '3', potreroName: 'Potrero Sur' },
      fatherId: '2',
      fatherTag: 'BOV-002',
    ...
    },
    {
      ...
      weight: 85,
      status: 'active',
      location: { potreroId: '4', potreroName: 'Corral de Crías' },
      motherId: '1',
      motherTag: 'BOV-001',
    ...
    // === PORCINOS ===
    {
      ...
      weight: 180,
      status: 'active',
      location: { potreroId: '5', potreroName: 'Corral Porcinos' },
    ...
    },
    {
      ...
      weight: 12,
      status: 'active',
      location: { potreroId: '6', potreroName: 'Corral Crías Porcinos' },
      motherId: '10',
      motherTag: 'POR-002',
      fatherId: '9',
      fatherTag: 'POR-001',
    ...
    // === AVES (sin seguimiento de padres) ===
    {
      ...
      weight: 2.5,
      status: 'active',
      location: { potreroId: '7', potreroName: 'Gallinero Principal' },
    ...
    },
    {
      ...
      weight: 8.5,
      status: 'active',
      location: { potreroId: '8', potreroName: 'Corral Pavos' },
    ...
    // === CAPRINOS ===
    {
      ...
      weight: 55,
      status: 'active',
      location: { potreroId: '9', potreroName: 'Corral Caprinos' },
...
export const getMockPecuarioTasks = async (): Promise<PecuarioTask[]> => {
  ...
  return [
    {
      id: '1',
      title: 'Vacunacion contra brucelosis',
      type: 'health',
      description: 'Aplicar vacuna contra brucelosis al lote de ganado bovino. Coordinar con veterinario.',
    ...
    {
      id: '2',
      title: 'Rotacion de ganado',
      type: 'rotation',
      potreroName: 'Potrero Sur',
      description: 'Mover el ganado del Potrero Central al Potrero Sur para descanso de pastos.',
    ...
    {
      id: '3',
      title: 'Revision de prenez',
      type: 'reproduction',
      livestockTag: 'BOV-003',
      description: 'Verificar estado de prenez de las vacas marcadas. Palpacion rectal.',
    ...
    },
    {
      ...
      description: 'Coordinar venta de novillos con comprador de Alajuela.',
    ...
    },
    {
      ...
      type: 'checkup',
      description: 'Pesaje mensual de terneros para monitorear crecimiento.',
